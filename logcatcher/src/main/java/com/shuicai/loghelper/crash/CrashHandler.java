package com.shuicai.loghelper.crash;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // com.shuicai.loghelper.crash.CrashHandler 实例
    ...
    private DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss",
            Locale.CHINA);
    /** 保证只有一个 com.shuicai.loghelper.crash.CrashHandler 实例 */
    private CrashHandler() {
//
    }
    /** 获取 com.shuicai.loghelper.crash.CrashHandler 实例 ,单例模式 */
...
// 设置该 com.shuicai.loghelper.crash.CrashHandler 为程序的默认处理器
